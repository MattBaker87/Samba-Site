...
from main.views.events import ListEvents, BookInstrument, CoordinateEvent
...
urlpatterns = patterns('sambasite.main.views.events',
    ...
    ####### Bookings #######
    url(r'^booking/sign_out_instrument/(?P<booking_id>\d+)/$', BookInstrument.as_view(), name='instrument_sign_out'),
    url(r'^booking/cancel_sign_out/(?P<booking_id>\d+)/$', BookInstrument.as_view(), name='cancel_sign_out'),
)