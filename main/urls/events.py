...
urlpatterns = patterns('sambasite.main.views.events',
    ...
    url(r'^coordinate/(?P<slug>[-\w]+)/$', 'coordinate_event', name='event_coordinate'),
    url(r'^cancel_coordinate/(?P<slug>[-\w]+)/$', 'cancel_coordinate_event', name='event_cancel_coordinate'),
    url(r'^edit/(?P<slug>[-\w]+)/$', 'edit_event', name='event_edit'),
    url(r'^edit/(?P<slug>[-\w]+)/players/$', 'edit_event_players', name='event_edit_players'),
