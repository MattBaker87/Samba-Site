...
from main.views.events import ListEvents, BookInstrument, CoordinateEvent, AddEvent, EditEvent, DeleteEvent, EditEventPlayers
...
urlpatterns = patterns('sambasite.main.views.events',
    ...
    url(r'^(?P<slug>[-\w]+)/edit/players/$', EditEventPlayers.as_view(), name='event_edit_players'),
    ...
    url(r'^(?P<slug>[-\w]+)/delete/$', DeleteEvent.as_view(), name='event_delete'),
